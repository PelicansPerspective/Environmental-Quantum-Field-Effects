...
def test_scaling_laws():
    ...
    try:
        ...
        assert all(
            e >= 0 for e in enhancements
        ), "Enhancements should be non-negative"
        ...
        for i in range(1, len(correlation_times)):
            assert (
                correlation_times[i] < correlation_times[i - 1]

...
def main():
    ...
    create_summary_plots(
        temperatures, chsh_values,
        times, amplifications,
        couplings, enhancements
    )
...
def create_summary_plots(temperatures, chsh_values, times, amplifications, 
                        couplings, enhancements):
    ...
    ax1.axhline(y=2*np.sqrt(2), color='g', linestyle='--', 
    ...
    ax4.axvline(x=2.0, color='r', linestyle='--', linewidth=2, 
                label='Classical bound')
    ax4.axvline(x=2*np.sqrt(2), color='g', linestyle='--', linewidth=2,
                label='Tsirelson bound')
